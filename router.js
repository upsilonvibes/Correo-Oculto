...
const vaultMatrix = {
    nicole: {
        ...
        <p>Ever since I messaged you on 1st June at 15:09 and you replied at that exact same moment, my life has never been the same. ⚡ Everyday I wake up knowing that there is someone truly beautiful who cares about me, keeps me company, and makes the world a whole lot brighter. ☀️❤️</p>
        
        <p>I cannot actually measure the amount of love and the absolute magnitude of joy I have been experiencing since you stepped into my life. 🌌📈 You make everything feel simple and breathtaking all at once. Lemme keep it short for now so you can process this first envelope. 💌</p>
        
        <p><em>Muchas, muchas gracias</em> for everything you are. Bye for now. 🥀</p>
    ...
    mercy: {
        ...
        <p>The story is honestly too long to be written as a casual text over social media, and also way too embarrassing to be delivered by word-of-mouth... 📱❌ That is exactly what forced me to resort to building this custom letter for you.</p>
        
        <p>Last year, you mentioned that chaotic situation in your former Form 2 class. I really should have been satisfied with that info and left it at peace, but instead, I chose to go out of my way and poke my nose into other people's business. 🤥👃</p>
        
        <p>During the April Holiday, I tried to play detective. I attempted to manipulate you and your best friend psychologically to try and force more info out of you two—a reckless process which I shouldn't have even started. 🧭⚠️ I had branded you two as "suspects" simply because your alibis had slight variations. Looking back, it was a total lapse of judgment on my end.</p>
        
        <p>One week before you went back to school, I finally came to my senses, realized how wrong I was, and decided to completely abandon the stupid survey. That is precisely why I disappeared for quite some time. 🌪️🏃‍♂️</p>
        
        <p>I want to take this opportunity to express my most heartfelt apologies to you for causing any underlying emotional distress at a time when you should have just been relaxing in preparation for school. 🌸💔</p>
        
        <p>I know this act of confession might make you question our friendship or lose a bit of trust in me right now. But I strongly believe it is better to own up to my mistakes and re-earn your respect properly, rather than letting things accumulate into major conflicts over the years. 🪵🧱</p>
        
        <p>Please rest assured that your secrets are absolutely safe with me, and I will always be right here for whatever support you might need moving forward. 🛡️✨</p>
        
        <p>Muchas, muchas gracias for hearing me out.</p>
    ...
    fridah: {
        ...
        <p>The message I am about to share is honestly far too long to be delivered via a casual text over social media, and way too embarrassing to be delivered face-to-face... Entre nous, I simply cannot bear the thought of looking directly into your eyes during the awkward turn of events. 🫣❌</p>
        
        <p>Well, sometime last year, I got wind of some highly sensitive drama that happened in your former Form 2 class. Instead of keeping my cool, staying in my lane, and being satisfied with that tiny hint, I unfortunately decided to go full "FBI mode." 🕵️‍♂️⚙️</p>
        
        <p>Over the April holiday, I spent some time actively trying to cross-question you (I am completely sure you can remember this) together with your bestie. I was trying to force hidden information out of you via psychological manipulation. The mere fact that you guys had slightly different alibis made me even more intensely suspicious. 🧭⚠️</p>
        
        <p>Just a single week before the re-opening of school for the second term, I finally came to my senses. Mon amie, I realized that I was crossing lines I was never supposed to touch... To be honest, I still don't fully understand why I chose to launch that stupid process in the first place. 📉🧠</p>
        
        <p>This entire incident got me thinking and deeply questioning my own character. Trust me, the weight of it really made me suffer. I therefore came to a firm resolution that I must reveal my hidden agenda and face the consequences head-on, rather than sitting on a ticking volcano of secrets and conflicts in the near future. 🌋💥</p>
        
        <p>I know that my decision to come clean right now might make you question our relationship, but I see it as a mutual benefit. I will no longer have to suffer from this burning guilt, and you will finally get the transparency you deserve. 🗺️🔓</p>
        
        <p>Anyway, that heavy chapter aside, I want to formally assure you that your secrets are absolutely safe with me. I will always be right here to support you whenever you need me, to the absolute best of my capacity. 🛡️🕊️</p>
        
        <p>Again, please accept my deepest apologies for causing you any emotional trauma and underlying distress. Muchas, muchas gracias for understanding me. <em>Paso a paso, se llega lejos.</em> 👣🌸</p>
...
let activeUserLetters = [];
let selectedRecipientInfo = {};
